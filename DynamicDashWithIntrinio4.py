...
def update_financialData(input_ticker, input_tradingDays, FY):
    ...
    return html.H1(children= input_ticker), dcc.Graph(id = TickerStockData.identifier + ' Price Data',
              figure = {
                      ...
                      }),html.H3(children='Fiscal Year: ' + FY), html.H4(children='Balance Sheet Statement'),create_table(balance_sheet_statement_DF),html.H4(children='Income Statement'),create_table(income_statement_DF),html.H4(children='Cash Flow Statement'),create_table(cash_flow_statement_DF)
